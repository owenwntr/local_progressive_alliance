...
The method used in this research is called "Coarsened Exact Matching" (CEM) [@iacusCausalInferenceBalance2012]. With any analysis of election results, there is a risk of ommitted variable bias. CEM is one way to try and find the true "causal effect" of a variable. CEM is relatively intuitive: it is a way of comparing data which is almost exactly identical in all regards aside from the effect we are testing. Data is 'coarsened', so continuous variables can be placed into categories, and data points which are an exact match are compared. In this research, the data is matched by 2018 vote share of the Conservatives, Labour, Liberal Democrats, Greens, independents, UKIP and 'others'; the percentage of residents born in the UK, retired, white, not deprived, who live in privately rented accomodation, and who have no qualifications.
